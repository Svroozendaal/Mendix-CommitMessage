...
- Contributors debugging change analysis and export behaviour.

## Reading order

1. `ARCHITECTURE.md` for runtime components, routes, and data-path model.
2. `PROCESSING_PIPELINE.md` for change analysis, export, and commit-message storage pipelines.
3. `EXPORT_CONTRACT.md` for the raw-change JSON contract.
4. `REPOSITORY_WORKFLOWS.md` for build/deploy/run workflows.
5. `OPEN_QUESTIONS.md` for unresolved decisions.
...
- `Processing/` (Git analysis, dump diffing, export, storage)
